        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <a style="float: right;width: 50px;height: 50px;line-height: 50px;color: whitesmoke;" href="login">登录</a>
                </div><!-- /.navbar-collapse -->
            </div><!-- /.container-fluid -->
        </nav>
    </div>
...
<div class="content">
    <div class="container" style="color: whitesmoke; background-color: darkgray; width: 88%;max-width: 1140px;padding-bottom: 60px;border-radius: 15px 15px 15px 15px;">
        <h1 style="padding: 20px;">新用户注册</h1>
        <div style="margin: 0 auto; width: 100%;">
            <form action="reg" method="post">
                <table align="center" style="font-size: 20px;">
                    ...
                    <tr>
                        <td>密码：</td>
                        <td style="height: 50px;"><input id="pwd" type="password" name="pwd"  style="color: black;"></td>
                    </tr>
                     <tr>
                        <td>确认密码：</td>
                        <td style="height: 50px;"><input id="repwd"  name="repwd" type="password"  style="color: black;"></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td style="height: 50px;"><input type="submit" value="提交" class="btn btn-info " >
