            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav" style="font-size: 18px;">
                        <li style="width: 120px;text-align: center;"><a href="dy.html">电影<span class="sr-only">(current)</span></a></li>
                        <li style="width: 120px;text-align: center;"><a href="dm.html">电视剧</a></li>
                        <li style="width: 120px;text-align: center;"><a href="music.html">音乐</a></li>
                    </ul>
                </div><!-- /.navbar-collapse -->
            </div><!-- /.container-fluid -->
        </nav>
...
<div class="content">
    <div class="container" style="color: whitesmoke; background-color: darkgray; width: 88%;max-width: 1140px;padding-bottom: 60px;border-radius: 15px 15px 15px 15px;">
        <h1 style="padding: 20px;">管理员登录</h1>
        <div style="margin: 0 auto; width: 100%;">
            <form method="post" action="admlogin">
                <table align="center" style="font-size: 20px;">
                    <tr>
                        <td>用户名：</td>
                        <td style="height: 50px;"><input type="text" name="adname" style="color: black;"/></td>
                    </tr>
                    <tr>
                        <td>密码：</td>
                        <td style="height: 50px;"><input type="password" name="adpass"  style="color: black;"></td>
                    </tr>

                    <tr>
                        <td></td>
                        <td style="height: 50px;"><input type="submit" value="登录" class="btn btn-info " >
