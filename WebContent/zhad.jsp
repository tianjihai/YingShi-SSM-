...
<center>
    ...
    <table border="1" width="80%"  class="table table-hover">
        <tr bgcolor="lightgreen">
            <td width="5%">序号</td><td width="30%">账户名</td><td width="30%">密码</td><td width="8%">操作</td>
        </tr>
        <div>
                <div>
                 <c:forEach items="${list}" var="list"> 
                    <tr>
                        ...
                        <td>${list.pwd}</td>
                        <td>
                            <a href="delzh?id=${list.id }" class="btn btn-info " onClick='return confirm("确定要删除吗？")'>删除</a>
                        </td>
                    </tr>
                    </c:forEach>
